...
export function ContactCTA() {
  return (
    <section className="py-24 lg:py-28 bg-[#1a2332] relative overflow-hidden">
      {/* Subtle Pattern */}
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 font-[family-name:var(--font-outfit)]">
            Let&apos;s Move Your Freight Together
          </h2>

          {/* Description */}
          <p className="text-lg md:text-xl text-white/90 mb-10 leading-relaxed max-w-[700px] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Button
              size="lg"
              className="bg-[#ff4433] hover:bg-[#e63d2e] text-white px-8 py-6 text-lg font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
              asChild
            >
